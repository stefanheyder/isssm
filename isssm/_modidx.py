...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'isssm.ce_method': { 'isssm.ce_method.ce_cholesky_block': ('cross_entropy_method.html#ce_cholesky_block', 'isssm/ce_method.py'),
            ...
            'isssm.kalman': { 'isssm.kalman.FFBS': ('kalman_filter_smoother.html#ffbs', 'isssm/kalman.py'),
                              'isssm.kalman.filter': ('kalman_filter_smoother.html#filter', 'isssm/kalman.py'),
                              ...
                              'isssm.kalman.simulate_smoothed_FW1994': ( 'kalman_filter_smoother.html#simulate_smoothed_fw1994',
                                                                         'isssm/kalman.py'),

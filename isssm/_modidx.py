...
d = { 'settings': { 'branch': 'main',
                ...
                'lib_path': 'isssm'},
  'syms': { 'isssm.ce_method': { 'isssm.ce_method.CEMProposal': ('cross_entropy_method.html#cemproposal', 'isssm/ce_method.py'),
                                 'isssm.ce_method._joint_cov': ('cross_entropy_method.html#_joint_cov', 'isssm/ce_method.py'),
